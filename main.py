...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.button_clear.configure(command=self.watermark)
...
# TODO: input text for watermark
# Put Watermark
    def watermark(self):
        self.canvas1.create_text(200, 200, text="TEST", font=("Arial",30,"bold"))
